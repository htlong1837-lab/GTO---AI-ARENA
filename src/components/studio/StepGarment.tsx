          ...
          return (
            ...
            >
              <div className="flex items-center gap-4 flex-1">
                ...
                <div className="relative w-16 h-20 sm:w-20 sm:h-24 rounded-xl overflow-hidden shrink-0 bg-stone-100 border border-[#E2D8C7]">
                  <img
                    src={g.image}
                    alt={g.name}
                ...
                <div className="flex-1">
                  ...
                  <p
                    className={`text-xs line-clamp-2 leading-relaxed mb-2 font-light ${
                  ...
                  <div className="flex items-center gap-3 text-[11px] opacity-80">
                    <span className="flex items-center gap-1">
                      <Clock className="w-3 h-3 text-[#DFB058]" />
              ...
              <div className="flex sm:flex-col items-center justify-between sm:justify-center w-full sm:w-auto pt-2 sm:pt-0 border-t sm:border-t-0 border-[#E2D8C7] gap-2 shrink-0">
                <span
                  className={`text-[10px] uppercase font-bold tracking-wider px-2.5 py-1 rounded-full ${
                    isSelected ? 'bg-[#DFB058] text-stone-950' : 'bg-stone-100 text-stone-700'
                  }`}
                >
                  {g.silhouette}
                </span>
                ...
                <div
                  className={`w-7 h-7 rounded-full flex items-center justify-center transition-all ${
                    isSelected
                      ? 'bg-[#DFB058] text-stone-950 shadow-sm'
                      : 'border border-stone-200 text-transparent group-hover:border-[#DFB058]'
                  }`}
                >
